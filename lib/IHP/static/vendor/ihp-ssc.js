...
window.callServerAction = function (action, payload, element) {
    var component = findActiveComponent(element || event.target || document.activeElement);
...
function initalizeSSC(component) {
    ...
    component.connection = new WebSocket(socketHost + component.dataset.path+'?props='+encodeURIComponent(component.dataset.props));
